...
$(window).on("load", function () {
  $(function () {
    ...
    $(function () {
      ...
      $(".home-link").on("click", function () {
        gsap.to(".baby-project", 0.5, { scale: 0.9 });
        gsap.to(".baby-project", 0, {
          width: "100%",
          height: "100vh",
          overflow: "hidden",
        });
        gsap.to(".baby-project", 0, { display: "none", delay: 0.7 });
        ...
        gsap.to(".fashion-project", 0, { display: "none", delay: 0.7 });
        gsap.to("portrait-project", 0.5, { scale: 0.9 });
        gsap.to("portrait-project", 0, {
          width: "100%",
          height: "100vh",
          overflow: "hidden",
        });
        gsap.to("portrait-project", 0, { display: "none", delay: 0.7 });
        gsap.to(".wedding-project", 0.5, { scale: 0.9 });
        gsap.to(".wedding-project", 0, {
          width: "100%",
          height: "100vh",
          overflow: "hidden",
        });
        gsap.to(".wedding-project", 0, { display: "none", delay: 0.7 });
        gsap.to("#about", 0.5, { scale: 0.9 });
        gsap.to("#about", 0, {
          width: "100%",
          height: "100vh",
      ...
      $(".wedding-project-link").on("click", function () {
        gsap.to("#home", 0.5, { scale: 0.9 });
        gsap.to("#home", 0, {
          width: "100%",
          height: "100vh",
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".wedding-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".wedding-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
      $(".portrait-project-link").on("click", function () {
        gsap.to("#home", 0.5, { scale: 0.9 });
        gsap.to("#home", 0, {
          width: "100%",
          height: "100vh",
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to("portrait-project", 0, { display: "block", delay: 0.7 });
        gsap.to("portrait-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
      $(".fashion-project-link").on("click", function () {
        gsap.to("#home", 0.5, { scale: 0.9 });
        gsap.to("#home", 0, {
          width: "100%",
          height: "100vh",
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".fashion-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".fashion-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
      $(".baby-project-link").on("click", function () {
        ...
        gsap.to("#home", 0, { display: "none", delay: 0.7 });
        gsap.to(".baby-project", 0, { display: "block", delay: 0.7 });
        gsap.to(".baby-project", 0.5, { scale: 1, delay: 1.1 });
        gsap.to(".project-name", 0.5, { opacity: 0, delay: 2.5 });
        gsap.to("#breaker", { display: "block" });
        gsap.to("#breaker", 0, { display: "none", delay: 1.7 });
      });
